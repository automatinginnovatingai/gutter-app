# Gutter App — Unified SQL Express & SQL Server Edition
## Initial GitHub Release — Version 1.0.0

This release introduces the fully unified version of the Gutter App, combining all features and license tiers into a single Windows `.exe` application. The app now supports **both SQL Express and SQL Server**, selected during installation, eliminating the need for separate builds or database versions.
...
Includes core workflow tools, gutter job entry, payroll calculation, and standard reporting.  
...
## Database
The Gutter App now supports **two database modes**, selected during installation:
